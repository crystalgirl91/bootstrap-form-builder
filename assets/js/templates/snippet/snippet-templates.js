define(function(require) {
  ...
  , textinput                = require('text!templates/snippet/textinput.html')
  , cascade2                 = require('text!templates/snippet/cascade2.html')
  , cascade3                 = require('text!templates/snippet/cascade3.html')
  , cascadeselect            = require('text!templates/snippet/cascade-select.html');
